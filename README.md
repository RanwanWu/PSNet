# PSNet:Parallel symmetric network for RGB-T salient object detection  Published in Neurocomputing [paper](https://pan.baidu.com/s/1V7DPu68B7uDzSHnTSE4h2g)[code:NEPU]
